...
#define ADC_C2A5        3   //Connector 2 A5 CC voltage (unused)
#define ADC_C2B5        4   //Connector 2 B5 CC voltage (unused)
...
#define ADC_CONFIG_C1B5 1, 		1,  1, 0, ADC_INPUTCTRL_MUXPOS_AIN13_Val, ADC_REFCTRL_REFSEL_INTREF_Val,  ADC_AVGCTRL_SAMPLENUM_16_Val,   63
#define ADC_CONFIG_C2A5 ADC_NA, 0,  0, 0, 0,                              0,                              0,                              0
...
#define ADC_5V_VOLTS_PER_COUNT      0.001904297f  //  =  78/10 / 4096
...
#define ADC_USBC_EXTRA_NOMINAL      850     //Nominal ADC value for detection of connected device  ***TBD may need adjustment

#define USBC_IS_SINK(a5, b5)        (a5 < ADC_USBC_EXTRA_NOMINAL || b5 < ADC_USBC_EXTRA_NOMINAL)

//#define USBC_IS_SINK(a5, b5)        ((a5 > ADC_USBC_EXTRA_ADC_MIN && a5 < ADC_USBC_EXTRA_ADC_MAX) || (b5 > ADC_USBC_EXTRA_ADC_MIN && b5 < ADC_USBC_EXTRA_ADC_MAX))

#if 0	// Do we need any of this? ***TBD
// *** Note: NUMPAD does not support ext USBC connectors
